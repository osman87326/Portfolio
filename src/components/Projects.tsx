  ...
  return (
    <section id="projects" ref={containerRef} className="px-6 lg:px-12 py-32 bg-surface relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className={projects.length > 0 ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" : "flex justify-center"}>
          {projects.length > 0 ? (
            ...
            <div className="py-20 text-center space-y-6">
              <div className="font-bebas text-6xl text-white/20 animate-pulse uppercase tracking-widest">
                TRANSMISSION_PENDING...
              </div>
              <p className="text-primary-container font-inter text-xs font-bold tracking-[0.4em] uppercase">
                Systems are calibrating. New projects arriving soon.
              </p>
            </div>
          )}
        </div>
